...
Correlation screen using FRQ as the number of tornadoes on a big day and INT as the upper quantile of per tornado energy dissipation.
...
```{r}
dfPlot <- data.frame(r, pval, theta)
library(ggplot2)
ggplot(dfPlot, aes(x = theta, y = r)) + 
...
text(0,0.55, '0.25', cex=1.4, col=colors()[229])
text(0,1.05, '0.50', cex=1.4, col=colors()[229])
